  ...
  return (
    <section id="founder" className="w-full mt-[5rem] flex flex-col items-center justify-center px-6">
      <div className="flex items-center gap-4 mb-2">
        {/* Gentleman */}
        <div id="founder" className="w-15 h-15 bg-green-200 border-1 border-green-300 rounded-full overflow-hidden">
          <Image
            src="/salihu.png"
        ...
        {/* Usman */}
        <div className="w-15 h-15 bg-green-200 border-1 border-green-300 rounded-full overflow-hidden">
          <Image
            src="/usman.JPG"
